...
const experience = [
    {
        ...
        description5: "HTML + CSS + JS",
        description6: "An Application for school staffs and students",
        description7: "can demo if you want",
    ...
    },
    {
        ...
        description5: "Get an email for new leads",
        description6: "SMS Marketing - Automated",
        description7: "Fixed the responsiveness of the whole website",
    ...
    },
    {
        ...
        description5: "Email Marketing - Automated",
        description6: "SMS Marketing - Automated",
        description7: "Fixed the responsiveness of the whole website",
    ...
    },
    {
        ...
        description4: "SEO configured for searchability in google console",
        description5: "Simple Intake Form",
        description6: "Get an email per submissions",
        description7: "Fixed the responsiveness of the whole website",
